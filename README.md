...
- [go-str2duration](https://github.com/xhit/go-str2duration) ⭐ 120 - Updated Sep 2026: Convert string to duration. Support time.Duration returned string and more.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 33337 - Updated Sep 2026: A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 710 - Updated May 2016: Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23070 - Updated Sep 2026: The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kitex](https://github.com/cloudwego/kitex) ⭐ 8043 - Updated Sep 2026: A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
...
- [NATS](https://github.com/nats-io/nats-server) ⭐ 20745 - Updated Sep 2026: NATS is a simple, secure, and performant communications system for digital systems, services, and devices.
...
- [raft](https://github.com/hashicorp/raft) ⭐ 9128 - Updated Sep 2026: Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 1124 - Updated Sep 2026: Go implementation of the Raft consensus protocol, by CoreOS.
- [rain](https://github.com/cenkalti/rain) ⭐ 1145 - Updated Aug 2026: BitTorrent client and library.
...
- [email-verifier](https://github.com/AfterShip/email-verifier) ⭐ 1621 - Updated Sep 2026: A Go library for email verification without sending any emails.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1488 - Updated Jul 2026: A simple Go library for sending mails in Go.
...
- [hermes](https://github.com/matcornic/hermes) ⭐ 3029 - Updated Apr 2025: Golang package that generates clean, responsive HTML e-mails.
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 16162 - Updated Aug 2022: Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 10389 - Updated Sep 2026: Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5860 - Updated Sep 2026: Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 8018 - Updated Jul 2026: Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 11346 - Updated Sep 2026: PHP embedded in Go, with a net/http handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 7102 - Updated Sep 2026: ECMAScript 5.1(+) implementation in Go.
...
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2766 - Updated Sep 2026: Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
...
- [tengo](https://github.com/d5/tengo) ⭐ 3839 - Updated Apr 2026: Bytecode compiled script language for Go.
...
- [afero](https://github.com/spf13/afero) ⭐ 6698 - Updated Jun 2026: FileSystem Abstraction System for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 5982 - Updated Sep 2026: Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8844 - Updated Aug 2026: PDF processor.
...
- [ach](https://github.com/moov-io/ach) ⭐ 565 - Updated Sep 2026: A reader, writer, and validator for Automated Clearing House (ACH) files.
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1662 - Updated Sep 2026: A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal](https://github.com/shopspring/decimal) ⭐ 7481 - Updated Aug 2026: Arbitrary-precision fixed-point decimal numbers.
...
- [indicator](https://github.com/cinar/indicator) ⭐ 1785 - Updated Sep 2026: Technical analysis library providing financial indicators, strategies, and backtesting framework.
- [ledger](https://github.com/formancehq/ledger) ⭐ 1391 - Updated Sep 2026: A programmable financial ledger that provides a foundation for money-moving applications.
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13491 - Updated Sep 2026: dead simple 2D game engine in Go.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 8579 - Updated Sep 2026: This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 14507 - Updated Jul 2026: A high-performance and low-cost goroutine pool in Go.
...
- [go-actor](https://github.com/vladopajic/go-actor) ⭐ 309 - Updated Sep 2026: A tiny library for writing concurrent programs using actor model.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 28704 - Updated Sep 2026: Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [unison](https://github.com/richardwilkes/unison) ⭐ 338 - Updated Sep 2026: A unified graphical user experience toolkit for Go desktop applications. macOS, Windows, and Linux are supported.
...
- [webview](https://github.com/zserge/webview) ⭐ 14234 - Updated Mar 2026: Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 5031 - Updated Sep 2026: Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [bimg](https://github.com/h2non/bimg) ⭐ 3034 - Updated Mar 2024: Small package for fast and efficient image processing using libvips.
...
- [gowitness](https://github.com/sensepost/gowitness) ⭐ 4514 - Updated Sep 2026: Screenshoting webpages using go and headless chrome on command line.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1606 - Updated Sep 2026: RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [gocron](https://github.com/go-co-op/gocron) ⭐ 7163 - Updated Jul 2026: Easy and fluent Go job scheduling. This is an actively maintained fork of jasonlvhit/gocron.
...
- [phuslu/log](https://github.com/phuslu/log) ⭐ 872 - Updated Sep 2026: High performance structured logging.
...
- [tint](https://github.com/lmittmann/tint) ⭐ 1356 - Updated Jul 2026: A slog.Handler that writes tinted logs.
...
- [zap](https://github.com/uber-go/zap) ⭐ 24654 - Updated Sep 2026: Fast, structured, leveled logging in Go.
...
- [zerolog](https://github.com/rs/zerolog) ⭐ 12503 - Updated Sep 2026: Zero-allocation JSON logger.
...
- [hugot](https://github.com/knights-analytics/hugot) ⭐ 650 - Updated Sep 2026: Huggingface transformer pipelines for golang with onnxruntime.
...
- [tfgo](https://github.com/galeone/tfgo) ⭐ 2494 - Updated Jul 2023: Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 13720 - Updated Jun 2026: A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10765 - Updated Sep 2026: Real-time messaging (Websockets or SockJS) server in Go.
...
- [NATS Go Client](https://github.com/nats-io/nats.go) ⭐ 6751 - Updated Sep 2026: Go client for the NATS
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 9897 - Updated Aug 2026: Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4939 - Updated Aug 2026: Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.
### Microsoft Excel
...
- [excelize](https://github.com/xuri/excelize) ⭐ 20921 - Updated Sep 2026: Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig](https://github.com/uber-go/dig) ⭐ 4501 - Updated May 2025: A reflection based dependency injection toolkit for Go.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56606 - Updated Apr 2026: Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see this issue for more information. Nonetheless, some may find the layout useful.
- [golang-templates/seed](https://github.com/golang-templates/seed) ⭐ 566 - Updated Sep 2026: Go application GitHub repository template.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 12105 - Updated Sep 2026: Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5388 - Updated Sep 2026: Random data generator written in go.
...
- [purego](https://github.com/ebitengine/purego) ⭐ 3962 - Updated Sep 2026: A library for calling C functions from Go without Cgo.
...
- [shoutrrr](https://github.com/containrrr/shoutrrr) ⭐ 1674 - Updated May 2026: Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
- [gse](https://github.com/go-ego/gse) ⭐ 2844 - Updated Sep 2026: Go efficient text segmentation; support english, chinese, japanese and other.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15725 - Updated Sep 2026: Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [gnet](https://github.com/panjf2000/gnet) ⭐ 11249 - Updated Jul 2026: gnet is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [gobgp](https://github.com/osrg/gobgp) ⭐ 4108 - Updated Sep 2026: BGP implemented in the Go Programming Language.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11774 - Updated Sep 2026: An implementation of the QUIC protocol in pure Go.
- [sdns](https://github.com/semihalev/sdns) ⭐ 1078 - Updated Sep 2026: A high-performance, recursive DNS resolver server with DNSSEC support, focused on preserving privacy.
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5500 - Updated Sep 2026: A pure go implementation of tun2socks powered by gVisor TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 16785 - Updated Sep 2026: A pure Go implementation of the WebRTC API.
...
- [gentleman](https://github.com/h2non/gentleman) ⭐ 1133 - Updated Dec 2023: Full-featured plugin-driven HTTP client library.
...
- [surf](https://github.com/enetx/surf) ⭐ 1826 - Updated Sep 2026: Advanced HTTP client with HTTP/1.1, HTTP/2, HTTP/3 (QUIC), SOCKS5 proxy support and browser-grade TLS fingerprinting.
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1856 - Updated Sep 2026: net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [ent](https://github.com/facebook/ent) ⭐ 17196 - Updated Sep 2026: An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- [GORM](https://github.com/go-gorm/gorm) ⭐ 39957 - Updated Sep 2026: The fantastic ORM library for Golang, aims to be developer friendly.
...
- [syft](https://github.com/anchore/syft) ⭐ 9579 - Updated Sep 2026: A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.

---
## Performance

- [ebpf-go](https://github.com/cilium/ebpf) ⭐ 7963 - Updated Sep 2026: Provides utilities for loading, compiling, and debugging eBPF programs.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23220 - Updated Sep 2026: A distributed tracing system.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 8035 - Updated Aug 2026: Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10763 - Updated Sep 2026: go generate based graphql server library.
...
- [play](https://github.com/paololazzari/play) ⭐ 589 - Updated Mar 2025: A TUI playground to experiment with your favorite programs, such as grep, sed, awk, jq and yq.
...
- [gosl](https://github.com/cpmech/gosl) ⭐ 1879 - Updated Dec 2025: Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more.
...
- [age](https://github.com/FiloSottile/age) ⭐ 23629 - Updated Aug 2026: A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2180 - Updated Sep 2026: A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 675 - Updated Sep 2026: Fast initramfs generator with full-disk encryption support.
...
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 5212 - Updated Sep 2026: Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 3824 - Updated Sep 2026: Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 9877 - Updated Sep 2026: Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [jsoniter](https://github.com/json-iterator/go) ⭐ 13866 - Updated Sep 2022 - ⚠️ Archived: High-performance 100% compatible drop-in replacement of "encoding/json".
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 75840 - Updated Sep 2026: Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 52274 - Updated Sep 2026: Highly-available key value store for shared configuration and service discovery.
...
- [flipt](https://github.com/markphelps/flipt) ⭐ 4903 - Updated Sep 2026: A self contained feature flag solution written in Go and Vue.js
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ⭐ 2110 - Updated Sep 2026: A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- [minio](https://github.com/minio/minio) ⭐ 61362 - Updated Feb 2026 - ⚠️ Archived: Minio is a distributed object storage server.
...
- [OpenRun](https://github.com/openrundev/openrun) ⭐ 975 - Updated Sep 2026: Open-source alternative to Google Cloud Run and AWS App Runner. Easily deploy internal tools across a team.
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 61083 - Updated Sep 2026: PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [RoadRunner](https://github.com/spiral/roadrunner) ⭐ 8507 - Updated Sep 2026: High-performance PHP application server, load-balancer and process manager.
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12539 - Updated Sep 2026: Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2757 - Updated Sep 2026: A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 10544 - Updated Jul 2026: A HTML templating language that has great developer tooling.
...
- [gnomock](https://github.com/orlangure/gnomock) ⭐ 1487 - Updated Apr 2026: integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 18467 - Updated Sep 2026: Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4985 - Updated Sep 2026: A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testo](https://github.com/ozontech/testo) ⭐ 159 - Updated Aug 2026: Plugin-based testing framework with suites, parallel tests, hooks and parametrization. Inspired by Pytest.
...
- [hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2516 - Updated Sep 2026: HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) ⭐ 3509 - Updated Sep 2026: browser automation library to control Chromium, Firefox and WebKit with a single API.
- [rod](https://github.com/go-rod/rod) ⭐ 7107 - Updated Aug 2026: A Devtools driver to make web automation and scraping easy.
...
- [goldmark](https://github.com/yuin/goldmark) ⭐ 5022 - Updated Sep 2026: A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3819 - Updated Jun 2026: Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [sh](https://github.com/mvdan/sh) ⭐ 9064 - Updated Sep 2026: Shell parser and formatter.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 25524 - Updated Sep 2026: Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14991 - Updated Sep 2026: GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) ⭐ 3653 - Updated Sep 2026: The official AWS SDK for the Go programming language.
...
- [github](https://github.com/google/go-github) ⭐ 11306 - Updated Sep 2026: Go library for accessing the GitHub REST API v3.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10769 - Updated Sep 2026: OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [libopenapi](https://github.com/pb33f/libopenapi) ⭐ 875 - Updated Jul 2026: Parse, validate, and work with OpenAPI, Swagger, Overlays, and Arazzo specifications.
...
- [minio-go](https://github.com/minio/minio-go) ⭐ 3000 - Updated Sep 2026: Minio Go Library for Amazon S3 compatible cloud storage.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4963 - Updated Aug 2026: Slack API in Go.
...
- [changie](https://github.com/miniscruff/changie) ⭐ 905 - Updated Aug 2026: Automated changelog tool for preparing releases with lots of customization options.
...
- [clipboard](https://github.com/golang-design/clipboard) ⭐ 862 - Updated Aug 2026: 📋 cross-platform clipboard package in Go.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 54579 - Updated May 2025: A tool for exploring each layer in a Docker image.
...
- [Failsafe-go](https://github.com/failsafe-go/failsafe-go) ⭐ 2250 - Updated Aug 2026: Fault tolerance and resilience patterns for Go.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 83117 - Updated Sep 2026: Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 16057 - Updated Sep 2026: Deliver Go binaries as fast and easily as possible.
...
- [lo](https://github.com/samber/lo) ⭐ 21430 - Updated Sep 2026: A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mani](https://github.com/alajmo/mani) ⭐ 769 - Updated May 2026: CLI tool to help you manage multiple repositories.
...
- [mimetype](https://github.com/gabriel-vasile/mimetype) ⭐ 2018 - Updated Aug 2026: Package for MIME type detection based on magic numbers.
...
- [retry-go](https://github.com/avast/retry-go) ⭐ 2955 - Updated Feb 2026: Simple library for retry mechanism.
...
- [sesh](https://github.com/joshmedeski/sesh) ⭐ 2829 - Updated Sep 2026: Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.
...
- [sqlx](https://github.com/jmoiron/sqlx) ⭐ 17736 - Updated May 2024: provides a set of extensions on top of the excellent built-in database/sql package.
...
- [validator](https://github.com/go-playground/validator) ⭐ 20172 - Updated Sep 2026: Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [go-git](https://github.com/go-git/go-git) ⭐ 7726 - Updated Sep 2026: highly extensible Git implementation in pure Go.
...
- [go-astiav](https://github.com/asticode/go-astiav) ⭐ 738 - Updated Sep 2026: Better C bindings for ffmpeg in GO.
- [go-astisub](https://github.com/asticode/go-astisub) ⭐ 713 - Updated Sep 2026: Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
...
- [Echo](https://github.com/labstack/echo) ⭐ 32710 - Updated Sep 2026: High performance, minimalist Go web framework.
...
- [Gin](https://github.com/gin-gonic/gin) ⭐ 89240 - Updated Sep 2026: Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [GoFr](https://github.com/gofr-dev/gofr) ⭐ 20913 - Updated Sep 2026: Gofr is an opinionated microservice development framework.
- [GoFrame](https://github.com/gogf/gf) ⭐ 13274 - Updated Sep 2026: GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- [goravel](https://github.com/goravel/goravel) ⭐ 4835 - Updated Jul 2026: A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 7366 - Updated Aug 2026: A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 4408 - Updated Sep 2026: Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [iWF](https://github.com/indeedeng/iwf) ⭐ 661 - Updated Aug 2026: iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
- [render](https://github.com/unrolled/render) ⭐ 1997 - Updated Sep 2026: Go package for easily rendering JSON, XML, and HTML template responses.
...
- [chi](https://github.com/go-chi/chi) ⭐ 22847 - Updated Sep 2026: Small, fast and expressive HTTP router built on net/context.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17735 - Updated Sep 2026: Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 12136 - Updated Sep 2026: Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 4030 - Updated Sep 2026: No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [workflow](https://github.com/luno/workflow) ⭐ 256 - Updated Sep 2026: A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 6312 - Updated Sep 2026: Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 4393 - Updated Sep 2026: A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as golang allowing you to embed zero trust principles directly into your applications. The OpenZiti Test Kitchen has numerous examples to draw inspiration from including a zero trust ssh client - zssh
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 19386 - Updated Sep 2026: A fast Go linters runner. It runs linters in parallel, uses caching, supports yaml config, has integrations with all major IDE and has dozens of linters included.
...
- [vim-go](https://github.com/fatih/vim-go) ⭐ 16218 - Updated Aug 2026: Go development plugin for Vim.
...
- [xgen](https://github.com/xuri/xgen) ⭐ 426 - Updated Sep 2026: XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17138 - Updated Oct 2024: A resiliency tool that helps applications tolerate random instance failures.
- [colima](https://github.com/abiosoft/colima) ⭐ 30870 - Updated Sep 2026: Container runtimes on macOS (and Linux) with minimal setup.
...
- [docker-volume-backup](https://github.com/offen/docker-volume-backup) ⭐ 4011 - Updated Sep 2026: Backup Docker volumes locally or to any S3, WebDAV, Azure Blob Storage, Dropbox or SSH compatible storage.
...
- [Flannel](https://github.com/flannel-io/flannel) ⭐ 9542 - Updated Sep 2026: Flannel is a network fabric for containers, designed for Kubernetes.
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 6882 - Updated Sep 2026: Lightweight, programmable telemetry for servers and workstations.
...
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2147 - Updated Sep 2026: Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 58064 - Updated Sep 2026: Fork of Gogs, entirely community driven.
...
- [Hey](https://github.com/rakyll/hey) ⭐ 20268 - Updated Jan 2026: Hey is a tiny program that sends some load to a web application.
...
- [k3d](https://github.com/k3d-io/k3d) ⭐ 6559 - Updated Jun 2026: Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 33991 - Updated Sep 2026: Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 31521 - Updated Sep 2026: A modern load testing tool, using Go and JavaScript.
- [k9s](https://github.com/derailed/k9s) ⭐ 34627 - Updated Sep 2026: Kubernetes CLI to manage your clusters in style.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 15496 - Updated Sep 2026: Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko](https://github.com/google/ko) ⭐ 8518 - Updated Aug 2026: Command line tool for building and deploying Go applications on Kubernetes
...
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3135 - Updated Sep 2026: KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 127814 - Updated Sep 2026: Container Cluster Manager from Google.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 32138 - Updated Sep 2026: Run Kubernetes locally.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15794 - Updated Sep 2026: Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
- [podman-tui](https://github.com/containers/podman-tui) ⭐ 1233 - Updated Sep 2026: Terminal UI for Podman management.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 5010 - Updated Sep 2026: Pomerium is an identity-aware access proxy.
...
- [traefik](https://github.com/containous/traefik) ⭐ 64896 - Updated Sep 2026: Reverse proxy and load balancer with support for multiple backends.
...
- [Updatecli](https://github.com/updatecli/updatecli) ⭐ 984 - Updated Sep 2026: A universal declarative update policy engine.
- [uTask](https://github.com/ovh/utask) ⭐ 1400 - Updated Jul 2026: Automation engine that models and executes business processes declared in yaml.
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25197 - Updated Feb 2026: HTTP load testing tool and library. It's over 9000!
...
- [Backrest](https://github.com/garethgeorge/backrest) ⭐ 7366 - Updated Jul 2026: Web-based UI and orchestrator for restic backup.
- [Better Go Playground](https://goplay.tools): Go playground with syntax highlight, code completion and other features.
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 6958 - Updated Sep 2026: Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc](https://github.com/schollz/croc) ⭐ 40375 - Updated Sep 2026: Easily and securely send files or folders from one computer to another.
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) ⭐ 5681 - Updated Aug 2026: A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [Gokapi](https://github.com/Forceu/gokapi) ⭐ 2873 - Updated Sep 2026: Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- [GooseForum](https://github.com/leancodebox/GooseForum) ⭐ 139 - Updated Sep 2026: Self-hosted forum platform built with Go, Vue, and Tailwind CSS.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 14440 - Updated Sep 2026: Distributed POSIX file system built on top of Redis and AWS S3.
...
- [onWatch](https://github.com/onllm-dev/onWatch) ⭐ 743 - Updated Sep 2026: Monitor AI API quotas across providers locally with historical tracking, alerts, and a web dashboard to avoid surprise throttling and budget overruns.
...
- [restic](https://github.com/restic/restic) ⭐ 36124 - Updated Aug 2026: De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 752 - Updated May 2026: sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 8763 - Updated Sep 2026: Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
...
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12350 - Updated Aug 2026: Proxy to simulate network and system conditions for automated tests.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 19678 - Updated Jul 2026: A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3992 - Updated Dec 2024: Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 48803 - Updated Aug 2026: Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33681 - Updated Mar 2022: List of other amazingly awesome lists.
...
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 28242 - Updated Jul 2017: Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 20145 - Updated Jun 2025: Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) ⭐ 23882 - Updated Aug 2026: Learn Go with test-driven development.
