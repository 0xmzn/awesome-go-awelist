...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 24240 - Updated Sep 2026: Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [aconfig](https://github.com/cristalhq/aconfig) ⭐ 642 - Updated Nov 2025: Simple, useful and opinionated config loader.
...
- [env](https://github.com/caarlos0/env) ⭐ 6311 - Updated Sep 2026: Parse environment variables to Go structs (with defaults).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 10635 - Updated May 2026: Go port of Ruby's dotenv library (Loads environment variables from .env).
...
- [koanf](https://github.com/knadh/koanf) ⭐ 4202 - Updated Aug 2026: Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 3177 - Updated Aug 2026: Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to kingpin).
...
- [sonic](https://github.com/bytedance/sonic) ⭐ 9597 - Updated Sep 2026: A blazingly fast JSON serializing & deserializing library.
...
- [viper](https://github.com/spf13/viper) ⭐ 30459 - Updated Oct 2025: Go configuration with fangs.
...
- [drone](https://github.com/drone/drone) ⭐ 38391 - Updated Sep 2026: Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [PikoCI](https://github.com/pikoci/pikoci) ⭐ 169 - Updated Sep 2026: Self-hosted CI/CD inspired by Concourse. Single binary, any database, any queue. HCL pipelines, pluggable resource types and runners.
- [roveralls](https://github.com/LawrenceWoodman/roveralls) ⭐ 22 - Updated Nov 2017: Recursive coverage testing tool.
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 7891 - Updated Sep 2026: Woodpecker is a community fork of the Drone CI system.
...
- [bitmap](https://github.com/kelindar/bitmap) ⭐ 383 - Updated Sep 2026: Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
...
- [iter](https://github.com/disksing/iter) ⭐ 197 - Updated Jul 2026: Go implementation of C++ STL iterators and algorithms.
### Maps
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 7962 - Updated Sep 2026: Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4706 - Updated Sep 2026: Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 11218 - Updated Aug 2026: Modern text indexing library for go.
...
- [BigCache](https://github.com/allegro/bigcache) ⭐ 8161 - Updated Sep 2026: Efficient key/value cache for gigabytes of data.
...
- [ttlcache](https://github.com/jellydator/ttlcache) ⭐ 1284 - Updated Sep 2026: An in-memory cache with item expiration and generics.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32473 - Updated Sep 2026: Scalable, Geo-Replicated, Transactional Datastore.
...
- [dolt](https://github.com/dolthub/dolt) ⭐ 24463 - Updated Sep 2026: Dolt – It's Git for Data.
...
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 31748 - Updated Sep 2026: Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 46153 - Updated Sep 2026: Milvus is a vector database for embedding management, analytics and search.
...
- [NornicDB](https://github.com/orneryd/NornicDB) ⭐ 878 - Updated Sep 2026: High performance graph + vector database (Neo4j and qDrant compatible), focused on low latency graph-rag retreival for AI systems.
- [nutsdb](https://github.com/xujiajun/nutsdb) ⭐ 3579 - Updated Sep 2026: Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 66117 - Updated Sep 2026: Monitoring system and time series database.
...
- [rqlite](https://github.com/rqlite/rqlite) ⭐ 17747 - Updated Sep 2026: The lightweight, distributed, relational database built on SQLite.
- [tempdb](https://github.com/rafaeljesus/tempdb) ⭐ 19 - Updated Feb 2018: Key-value store for temporary items.
- [tidb](https://github.com/pingcap/tidb) ⭐ 40549 - Updated Sep 2026: TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17739 - Updated Sep 2026: fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 14496 - Updated Sep 2026: Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 150 - Updated Dec 2019: Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 7392 - Updated Sep 2026: A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 11472 - Updated Sep 2026: Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate](https://github.com/golang-migrate/migrate) ⭐ 18929 - Updated Sep 2026: Database migrations. CLI and Golang library.
...
- [chproxy](https://github.com/Vertamedia/chproxy) ⭐ 1483 - Updated Apr 2026: HTTP proxy for ClickHouse database.
...
- [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4968 - Updated Sep 2026: Go toolset to handle MySQL protocol and replication.
...
- [gorm-multitenancy](https://github.com/bartventer/gorm-multitenancy) ⭐ 85 - Updated Dec 2025: Multi-tenancy support for GORM managed databases.
...
- [onedump](https://github.com/liweiyi88/onedump) ⭐ 995 - Updated Jul 2026: Database backup from different drivers to different destinations with one command and configuration.
- [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1400 - Updated Sep 2026: Advanced scheduling for PostgreSQL.
- [pgrwl](https://github.com/pgrwl/pgrwl) ⭐ 182 - Updated Sep 2026: Cloud-native continuous backup for PostgreSQL.
- [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9508 - Updated Jul 2026: Web-based PostgreSQL database browser.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 21345 - Updated Sep 2026: vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [gendry](https://github.com/didi/gendry) ⭐ 1634 - Updated Mar 2025 - ⚠️ Archived: Non-invasive SQL builder and powerful data binder.
...
- [jet](https://github.com/go-jet/jet) ⭐ 3802 - Updated Aug 2026: Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 18302 - Updated Sep 2026: Generate type-safe code from SQL.
...
- [cayley](https://github.com/google/cayley) ⭐ 15065 - Updated Jul 2024: Graph database with support for multiple backends.
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) ⭐ 15285 - Updated Sep 2026: MySQL driver for Go.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 14255 - Updated Sep 2026: PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- [redis](https://github.com/redis/go-redis) ⭐ 22241 - Updated Sep 2026: Redis client for Golang.
...
- [go-elasticsearch](https://github.com/elastic/go-elasticsearch) ⭐ 6069 - Updated Sep 2026: Official Elasticsearch client for Go.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1910 - Updated Sep 2026: Fast trigram based code search.
