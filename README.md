...
- [Ergo](https://github.com/ergo-services/ergo) ⭐ 4661 - Updated Sep 2026: An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
...
- [Aetheris](https://github.com/Colin4k1024/Aetheris) ⭐ 19 - Updated Sep 2026: AI Agent execution runtime with event sourcing, checkpoint recovery, and At-Most-Once execution guarantee. Written in Go.
...
- [LocalAI](https://github.com/mudler/LocalAI) ⭐ 49168 - Updated Sep 2026: Open Source OpenAI alternative, self-host AI models.
...
- [mcp-go](https://github.com/mark3labs/mcp-go) ⭐ 9127 - Updated Sep 2026: Go implementation of the Model Context Protocol for building MCP servers and clients in Go.
- [Ollama](https://github.com/jmorganca/ollama) ⭐ 181267 - Updated Sep 2026: Run large language models locally.
...
- [trpc-agent-go](https://github.com/trpc-group/trpc-agent-go) ⭐ 1805 - Updated Sep 2026: Framework for building LLM-based multi-agent systems.
...
- [casbin](https://github.com/hsluoyz/casbin) ⭐ 20398 - Updated Sep 2026: Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth](https://github.com/markbates/goth) ⭐ 6605 - Updated Feb 2026: provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [keto](https://github.com/ory/keto) ⭐ 5399 - Updated Jul 2026: Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oidc](https://github.com/zitadel/oidc) ⭐ 1890 - Updated Sep 2026: Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation.
- [openfga](https://github.com/openfga/openfga) ⭐ 5795 - Updated Sep 2026: Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by CNCF.
...
- [spicedb](https://github.com/authzed/spicedb) ⭐ 7077 - Updated Sep 2026: A Zanzibar-inspired database that enables fine-grained authorization.
...
- [cometbft](https://github.com/cometbft/cometbft) ⭐ 919 - Updated Sep 2026: A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) ⭐ 51351 - Updated Sep 2026: Official Go implementation of the Ethereum protocol.
...
- [bot](https://github.com/go-telegram/bot) ⭐ 1842 - Updated Sep 2026: Zero-dependencies Telegram Bot library with additional UI components.
...
- [telego](https://github.com/mymmrac/telego) ⭐ 1074 - Updated Sep 2026: Telegram Bot API library for Golang with full one-to-one API implementation.
...
- [air](https://github.com/cosmtrek/air) ⭐ 23997 - Updated Aug 2026: Air - Live reload for Go apps.
...
- [mage](https://github.com/magefile/mage) ⭐ 4692 - Updated Apr 2026: Mage is a make/rake-like build tool using Go.
...
- [Task](https://github.com/go-task/task) ⭐ 16165 - Updated Sep 2026: simple "Make" alternative.
- [taskctl](https://github.com/taskctl/taskctl) ⭐ 326 - Updated Jul 2026: Concurrent task runner.
- [xc](https://github.com/joerdav/xc) ⭐ 1401 - Updated Sep 2026: Task runner with README.md defined tasks, executable markdown.
...
- [asciigraph](https://github.com/guptarohit/asciigraph) ⭐ 3093 - Updated Jun 2026: Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
- [aurora](https://github.com/logrusorgru/aurora) ⭐ 1495 - Updated Jan 2025: ANSI terminal colors that support fmt.Printf/Sprintf.
- [box-cli-maker](https://github.com/box-cli-maker/box-cli-maker) ⭐ 664 - Updated Sep 2026: Render highly customizable boxes in the terminal.
- [bubble-table](https://github.com/Evertras/bubble-table) ⭐ 579 - Updated Sep 2026: An interactive table component for bubbletea.
- [bubbles](https://github.com/charmbracelet/bubbles) ⭐ 8923 - Updated Sep 2026: TUI components for bubbletea.
- [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 45029 - Updated Sep 2026: Go framework to build terminal apps, based on The Elm Architecture.
...
- [fx](https://github.com/antonmedv/fx) ⭐ 20634 - Updated Aug 2026: Terminal JSON viewer & processor.
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) ⭐ 11850 - Updated Sep 2026: Declaratively define styles for color, format and layout in the terminal.
...
- [pterm](https://github.com/pterm/pterm) ⭐ 5538 - Updated Jul 2026: A library to beautify console output on every platform with many combinable components.
...
- [carapace](https://github.com/rsteube/carapace) ⭐ 1443 - Updated Sep 2026: Command argument completion generator for spf13/cobra.
- [carapace-bin](https://github.com/rsteube/carapace-bin) ⭐ 1960 - Updated Sep 2026: Multi-shell multi-command argument completer.
...
- [cobra](https://github.com/spf13/cobra) ⭐ 44614 - Updated Jul 2026: Commander for modern Go CLI interactions.
...
- [Dnote](https://github.com/dnote/dnote) ⭐ 3082 - Updated Jul 2026: A simple command line notebook with multi-device sync.
...
- [go-arg](https://github.com/alexflint/go-arg) ⭐ 2280 - Updated Dec 2025: Struct-based argument parsing in Go.
...
- [memsh](https://github.com/amjadjibon/memsh) ⭐ 14 - Updated Jul 2026: Virtual bash shell in Go: executes shell commands against an in-memory filesystem (afero), with WASM plugin support and an embeddable HTTP server.
...
- [cli](https://gitlab.com/gitlab-org/cli) ⭐ 1094 - Updated Sep 2026: An open-source GitLab command line tool bringing GitLab's cool features to your command line.
