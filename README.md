...
- [urfave/cli](https://github.com/urfave/cli) ⭐ 24241 - Updated Sep 2026: Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv](https://github.com/ilyakaznacheev/cleanenv) ⭐ 2164 - Updated Sep 2025: Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [godotenv](https://github.com/joho/godotenv) ⭐ 10634 - Updated May 2026: Go port of Ruby's dotenv library (Loads environment variables from .env).
...
- [koanf](https://github.com/knadh/koanf) ⭐ 4204 - Updated Aug 2026: Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [kong](https://github.com/alecthomas/kong) ⭐ 3179 - Updated Aug 2026: Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to kingpin).
...
- [xdg](https://github.com/adrg/xdg) ⭐ 1020 - Updated Sep 2026: Go implementation of the XDG Base Directory Specification and XDG user directories.
...
- [drone](https://github.com/drone/drone) ⭐ 38396 - Updated Sep 2026: Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) ⭐ 7895 - Updated Sep 2026: Woodpecker is a community fork of the Drone CI system.
...
- [Benthos](https://github.com/benthosdev/benthos) ⭐ 8759 - Updated Sep 2026: A message streaming bridge between a range of protocols.
...
- [roaring](https://github.com/RoaringBitmap/roaring) ⭐ 2941 - Updated Sep 2026: Go package implementing compressed bitsets.
### Bit Sets
...
- [hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 7970 - Updated Sep 2026: Distributed, Fault-tolerant task queue.
...
- [golang-set](https://github.com/deckarep/golang-set) ⭐ 4728 - Updated Sep 2026: Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve](https://github.com/blevesearch/bleve) ⭐ 11219 - Updated Aug 2026: Modern text indexing library for go.
...
- [buntdb](https://github.com/tidwall/buntdb) ⭐ 4871 - Updated May 2026: Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
- [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32475 - Updated Sep 2026: Scalable, Geo-Replicated, Transactional Datastore.
...
- [Databunker](https://github.com/paranoidguy/databunker) ⭐ 1485 - Updated Jul 2026: Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
...
- [dolt](https://github.com/dolthub/dolt) ⭐ 24475 - Updated Sep 2026: Dolt – It's Git for Data.
...
- [immudb](https://github.com/codenotary/immudb) ⭐ 9035 - Updated Sep 2026: immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb](https://github.com/influxdb/influxdb) ⭐ 31746 - Updated Sep 2026: Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus](https://github.com/milvus-io/milvus) ⭐ 46161 - Updated Sep 2026: Milvus is a vector database for embedding management, analytics and search.
...
- [NornicDB](https://github.com/orneryd/NornicDB) ⭐ 881 - Updated Sep 2026: High performance graph + vector database (Neo4j and qDrant compatible), focused on low latency graph-rag retreival for AI systems.
...
- [prometheus](https://github.com/prometheus/prometheus) ⭐ 66130 - Updated Sep 2026: Monitoring system and time series database.
...
- [tidb](https://github.com/pingcap/tidb) ⭐ 40552 - Updated Sep 2026: TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17742 - Updated Sep 2026: fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
- [minisql](https://github.com/RichardKnop/minisql) ⭐ 49 - Updated Aug 2026: Embedded single file SQL database.
### Database Schema Migration

- [atlas](https://github.com/ariga/atlas) ⭐ 8733 - Updated Sep 2026: A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase](https://github.com/bytebase/bytebase) ⭐ 14497 - Updated Sep 2026: Safe database schema change and version control for DevOps teams.
- [darwin](https://github.com/GuiaBolso/darwin) ⭐ 150 - Updated Dec 2019: Database schema evolution library for Go.
- [dbmate](https://github.com/amacneil/dbmate) ⭐ 7391 - Updated Sep 2026: A lightweight, framework-agnostic database migration tool.
...
- [goose](https://github.com/pressly/goose) ⭐ 11480 - Updated Sep 2026: Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [onedump](https://github.com/liweiyi88/onedump) ⭐ 996 - Updated Jul 2026: Database backup from different drivers to different destinations with one command and configuration.
...
- [pREST](https://github.com/prest/prest) ⭐ 4619 - Updated Sep 2026: Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
- [vitess](https://github.com/youtube/vitess) ⭐ 21344 - Updated Sep 2026: vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) ⭐ 671 - Updated Sep 2026: Powerful data retrieval methods as well as DB-agnostic query building capabilities.
...
- [relica](https://github.com/coregx/relica) ⭐ 26 - Updated Sep 2026: Type-safe database query builder with zero production dependencies, LRU statement cache, batch operations, and support for JOINs, subqueries, CTEs, and window functions.
...
- [sqlc](https://github.com/kyleconroy/sqlc) ⭐ 18304 - Updated Sep 2026: Generate type-safe code from SQL.
...
- [go-sqlite3](https://github.com/ncruces/go-sqlite3) ⭐ 1109 - Updated Sep 2026: This Go module is compatible with the database/sql driver. It allows embedding SQLite into your application, provides direct access to its C API, supports SQLite VFS, and also includes a GORM driver.
...
- [pgx](https://github.com/jackc/pgx) ⭐ 14254 - Updated Sep 2026: PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- [zoekt](https://github.com/sourcegraph/zoekt) ⭐ 1912 - Updated Sep 2026: Fast trigram based code search.
