...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3332 - Updated Sep 2026: Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [go-micro](https://github.com/micro/go-micro) ⭐ 23069 - Updated Sep 2026: A distributed systems development framework.
...
- [go-zero](https://github.com/tal-tech/go-zero) ⭐ 33333 - Updated Sep 2026: A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc](https://github.com/valyala/gorpc) ⭐ 710 - Updated May 2016: Simple, fast and scalable RPC library for high load.
- [grpc-go](https://github.com/grpc/grpc-go) ⭐ 23068 - Updated Sep 2026: The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kratos](https://github.com/go-kratos/kratos) ⭐ 25932 - Updated Jun 2026: A modular-designed and easy-to-use microservices framework in Go.
...
- [NATS](https://github.com/nats-io/nats-server) ⭐ 20734 - Updated Sep 2026: NATS is a simple, secure, and performant communications system for digital systems, services, and devices.
...
- [oras](https://github.com/oras-project/oras) ⭐ 2433 - Updated Sep 2026: CLI and library for OCI Artifacts in container registries.
...
- [raft](https://github.com/hashicorp/raft) ⭐ 9127 - Updated Sep 2026: Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft](https://github.com/etcd-io/raft) ⭐ 1120 - Updated Sep 2026: Go implementation of the Raft consensus protocol, by CoreOS.
...
- [Temporal](https://github.com/temporalio/sdk-go) ⭐ 968 - Updated Sep 2026: Durable execution system for making code fault-tolerant and simple.
...
- [go-mail](https://github.com/wneessen/go-mail) ⭐ 1487 - Updated Jul 2026: A simple Go library for sending mails in Go.
...
- [Maddy](https://github.com/foxcpp/maddy) ⭐ 6090 - Updated Sep 2026: All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog](https://github.com/mailhog/MailHog) ⭐ 16161 - Updated Aug 2022: Email and SMTP testing with web and API interface.
- [Mailpit](https://github.com/axllent/mailpit) ⭐ 10381 - Updated Sep 2026: Email and SMTP testing tool for developers.
...
- [mox](https://github.com/mjl-/mox) ⭐ 5859 - Updated Sep 2026: Modern full-featured secure mail server for low-maintenance, self-hosted email.
...
- [expr](https://github.com/antonmedv/expr) ⭐ 8016 - Updated Jul 2026: Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- [FrankenPHP](https://github.com/dunglas/frankenphp) ⭐ 11347 - Updated Sep 2026: PHP embedded in Go, with a net/http handler.
...
- [goja](https://github.com/dop251/goja) ⭐ 7100 - Updated Sep 2026: ECMAScript 5.1(+) implementation in Go.
...
- [prolog](https://github.com/ichiban/prolog) ⭐ 733 - Updated Oct 2024: Embeddable Prolog.
- [purl](https://github.com/ian-kent/purl) ⭐ 41 - Updated Dec 2014: Perl 5.18.2 embedded in Go.
- [starlark-go](https://github.com/google/starlark-go) ⭐ 2763 - Updated Sep 2026: Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
...
- [go-multierror](https://github.com/hashicorp/go-multierror) ⭐ 2584 - Updated Apr 2026: Go (golang) package for representing a list of errors as a single error.
...
- [multierr](https://github.com/uber-go/multierr) ⭐ 1203 - Updated Apr 2024: Package for representing a list of errors as a single error.
...
- [afero](https://github.com/spf13/afero) ⭐ 6697 - Updated Jun 2026: FileSystem Abstraction System for Go.
- [afs](https://github.com/viant/afs) ⭐ 401 - Updated Sep 2026: Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [gdu](https://github.com/dundee/gdu) ⭐ 5979 - Updated Sep 2026: Disk usage analyzer with console interface.
...
- [pdfcpu](https://github.com/pdfcpu/pdfcpu) ⭐ 8842 - Updated Aug 2026: PDF processor.
...
- [bbgo](https://github.com/c9s/bbgo) ⭐ 1661 - Updated Sep 2026: A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [gobl](https://github.com/invopop/gobl) ⭐ 307 - Updated Sep 2026: Invoice and billing document framework. JSON Schema based. Automates tax calculations and validation, with tooling to convert into global formats.
- [indicator](https://github.com/cinar/indicator) ⭐ 1774 - Updated Sep 2026: Technical analysis library providing financial indicators, strategies, and backtesting framework.
- [ledger](https://github.com/formancehq/ledger) ⭐ 1389 - Updated Sep 2026: A programmable financial ledger that provides a foundation for money-moving applications.
...
- [ticker](https://github.com/achannarasappa/ticker) ⭐ 6234 - Updated Jun 2026: Terminal stock watcher and stock position tracker.
...
- [roamer](https://github.com/slipros/roamer) ⭐ 6 - Updated Sep 2026: Eliminates boilerplate code for parsing HTTP requests by binding cookies, headers, query params, path params, body to structs and more by using simple tags.

---
## Functional
_Packages to support functional programming in Go._

- [fp-go](https://github.com/repeale/fp-go) ⭐ 323 - Updated Dec 2022: Collection of Functional Programming helpers powered by Golang 1.18+ generics.
...
- [mo](https://github.com/samber/mo) ⭐ 3416 - Updated Sep 2026: Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13489 - Updated Sep 2026: dead simple 2D game engine in Go.
...
- [gogpu](https://github.com/gogpu/gogpu) ⭐ 395 - Updated Sep 2026: GPU application framework with windowing, input, and rendering built on WebGPU — reduces 480+ lines of GPU code to ~20, zero CGO (GoGPU ecosystem: gg, ui, wgpu, naga).
...
- [gonet](https://github.com/xtaci/gonet) ⭐ 1284 - Updated Jul 2024 - ⚠️ Archived: Game server skeleton implemented with golang.
...
- [Pitaya](https://github.com/topfreegames/pitaya) ⭐ 2829 - Updated Jun 2026: Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go](https://github.com/gen2brain/raylib-go) ⭐ 2535 - Updated Aug 2026: Go bindings for raylib, a simple and easy-to-use library to learn videogames programming.
...
- [oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 8575 - Updated Sep 2026: This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [H3](https://github.com/uber/h3-go) ⭐ 452 - Updated Sep 2026: Go bindings for H3, a hierarchical hexagonal geospatial indexing system.
...
- [ants](https://github.com/panjf2000/ants) ⭐ 14506 - Updated Jul 2026: A high-performance and low-cost goroutine pool in Go.
...
- [Cogent Core](https://github.com/cogentcore/core) ⭐ 2347 - Updated Sep 2026: A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
- [fyne](https://github.com/fyne-io/fyne) ⭐ 28701 - Updated Sep 2026: Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [webview](https://github.com/zserge/webview) ⭐ 14232 - Updated Mar 2026: Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo](https://github.com/go-vgo/robotgo) ⭐ 10813 - Updated Sep 2026: Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [arduino-cli](https://github.com/arduino/arduino-cli) ⭐ 5029 - Updated Sep 2026: Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [bild](https://github.com/anthonynsimon/bild) ⭐ 4213 - Updated Sep 2026: Collection of image processing algorithms in pure Go.
...
- [gocv](https://github.com/hybridgroup/gocv) ⭐ 7502 - Updated Jan 2026: Go package for computer vision using OpenCV 3.3+.
...
- [rulego](https://github.com/rulego/rulego) ⭐ 1605 - Updated Sep 2026: RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- [scheduler](https://github.com/carlescere/scheduler) ⭐ 468 - Updated Jan 2017: Cronjobs scheduling made easy.
...
- [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1406 - Updated May 2026: A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
...
- [logrus](https://github.com/Sirupsen/logrus) ⭐ 25744 - Updated Aug 2026: Structured logger for Go.
...
- [spew](https://github.com/davecgh/go-spew) ⭐ 6423 - Updated Aug 2018: Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [timberjack](https://github.com/DeRuina/timberjack) ⭐ 162 - Updated Aug 2026: Rolling logger with size-based, time-based, and scheduled clock-based rotation, supporting compression and cleanup.
...
- [GoMLX](https://github.com/gomlx/gomlx) ⭐ 1638 - Updated Sep 2026: An accelerated Machine Learning framework for Go.
...
- [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 3003 - Updated Oct 2022: A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
- [Asynq](https://github.com/hibiken/asynq) ⭐ 13714 - Updated Jun 2026: A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo](https://github.com/centrifugal/centrifugo) ⭐ 10762 - Updated Sep 2026: Real-time messaging (Websockets or SockJS) server in Go.
...
- [gorush](https://github.com/appleboy/gorush) ⭐ 8775 - Updated Jul 2026: Push notification server using APNs2 and google GCM.
...
- [hypermatch](https://github.com/SchwarzIT/hypermatch) ⭐ 39 - Updated Sep 2026: A very fast and efficient Go library for matching events to a large set of rules
...
- [Mercure](https://github.com/dunglas/mercure) ⭐ 5323 - Updated Sep 2026: Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [Watermill](https://github.com/ThreeDotsLabs/watermill) ⭐ 9896 - Updated Aug 2026: Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
- [zmq4](https://github.com/pebbe/zmq4) ⭐ 1264 - Updated Jul 2025: Go interface to ZeroMQ version 4. Also available for version 3 and version 2.

---
## Microsoft Office

- [unioffice](https://github.com/unidoc/unioffice) ⭐ 4938 - Updated Aug 2026: Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.
### Microsoft Excel
...
- [excelize](https://github.com/xuri/excelize) ⭐ 20918 - Updated Sep 2026: Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [fx](https://github.com/uber-go/fx) ⭐ 7683 - Updated Dec 2025: A dependency injection based application framework for Go (built on top of dig).
...
- [ardanlabs/service](https://github.com/ardanlabs/service) ⭐ 4117 - Updated Sep 2026: A starter kit for building production grade scalable web service applications.
...
- [go-blueprint](https://github.com/Melkeydev/go-blueprint) ⭐ 8950 - Updated Jul 2025: Allows users to spin up a quick Go project using a popular framework.
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) ⭐ 56600 - Updated Apr 2026: Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see this issue for more information. Nonetheless, some may find the layout useful.
...
- [gatus](https://github.com/TwinProduction/gatus) ⭐ 12094 - Updated Sep 2026: Automated service health dashboard.
...
- [gofakeit](https://github.com/brianvoe/gofakeit) ⭐ 5389 - Updated Sep 2026: Random data generator written in go.
...
- [gopsutil](https://github.com/shirou/gopsutil) ⭐ 11921 - Updated Sep 2026: Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [gtree](https://github.com/ddddddO/gtree) ⭐ 362 - Updated Sep 2026: Provide CLI, Package and Web for tree output and directories creation from Markdown or programmatically.
...
- [purego](https://github.com/ebitengine/purego) ⭐ 3958 - Updated Sep 2026: A library for calling C functions from Go without Cgo.
...
- [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15679 - Updated Sep 2026: Cloudflare Tunnel client (formerly Argo Tunnel).
...
- [GoProxy](https://github.com/elazarl/goproxy) ⭐ 6759 - Updated Sep 2026: A library to create a customized HTTP/HTTPS proxy server using Go.
...
- [grab](https://github.com/cavaliercoder/grab) ⭐ 1485 - Updated Aug 2026: Go package for managing file downloads.
...
- [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4555 - Updated May 2026: KCP - Fast and Reliable ARQ Protocol.
...
- [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11773 - Updated Sep 2026: An implementation of the QUIC protocol in pure Go.
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5498 - Updated Sep 2026: A pure go implementation of tun2socks powered by gVisor TCP/IP stack.
...
- [webrtc](https://github.com/pions/webrtc) ⭐ 16782 - Updated Sep 2026: A pure Go implementation of the WebRTC API.
...
- [resty](https://github.com/go-resty/resty) ⭐ 11804 - Updated Sep 2026: Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- [surf](https://github.com/enetx/surf) ⭐ 1825 - Updated Sep 2026: Advanced HTTP client with HTTP/1.1, HTTP/2, HTTP/3 (QUIC), SOCKS5 proxy support and browser-grade TLS fingerprinting.
- [tls-client](https://github.com/bogdanfinn/tls-client) ⭐ 1855 - Updated Sep 2026: net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.
...
- [bun](https://github.com/uptrace/bun) ⭐ 4976 - Updated Aug 2026: SQL-first Golang ORM. Successor of go-pg.
...
- [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) ⭐ 1731 - Updated Aug 2026: A flexible and powerful SQL string builder library plus a zero-config ORM.
...
- [syft](https://github.com/anchore/syft) ⭐ 9574 - Updated Sep 2026: A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.

---
## Performance

- [ebpf-go](https://github.com/cilium/ebpf) ⭐ 7962 - Updated Sep 2026: Provides utilities for loading, compiling, and debugging eBPF programs.
...
- [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23217 - Updated Sep 2026: A distributed tracing system.
...
- [pixie](https://github.com/pixie-labs/pixie) ⭐ 6537 - Updated Jul 2026: No instrumentation tracing for Golang applications via eBPF.
...
- [dasel](https://github.com/tomwright/dasel) ⭐ 8034 - Updated Aug 2026: Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [play](https://github.com/paololazzari/play) ⭐ 588 - Updated Mar 2025: A TUI playground to experiment with your favorite programs, such as grep, sed, awk, jq and yq.
...
- [ewma](https://github.com/VividCortex/ewma) ⭐ 447 - Updated Apr 2021: Exponentially-weighted moving averages.
...
- [age](https://github.com/FiloSottile/age) ⭐ 23613 - Updated Aug 2026: A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2177 - Updated Sep 2026: A secure low code honeypot framework, leveraging AI for System Virtualization.
- [booster](https://github.com/anatol/booster) ⭐ 674 - Updated Sep 2026: Fast initramfs generator with full-disk encryption support.
...
- [Cameradar](https://github.com/Ullaakut/cameradar) ⭐ 5211 - Updated Sep 2026: Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza](https://github.com/corazawaf/coraza) ⭐ 3821 - Updated Sep 2026: Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego](https://github.com/go-acme/lego) ⭐ 9873 - Updated Sep 2026: Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [Caddy](https://github.com/caddyserver/caddy) ⭐ 75824 - Updated Sep 2026: Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- [etcd](https://github.com/etcd-io/etcd) ⭐ 52270 - Updated Sep 2026: Highly-available key value store for shared configuration and service discovery.
...
- [Fider](https://github.com/getfider/fider) ⭐ 4530 - Updated Jul 2026: Fider is an open platform to collect and organize customer feedback.
...
- [flipt](https://github.com/markphelps/flipt) ⭐ 4902 - Updated Sep 2026: A self contained feature flag solution written in Go and Vue.js
...
- [goshs](https://github.com/patrickhener/goshs) ⭐ 978 - Updated Sep 2026: SimpleHTTPServer replacement with file upload/download, WebDAV, SFTP, SMB, TLS, authentication, and share links.
...
- [pocketbase](https://github.com/pocketbase/pocketbase) ⭐ 61069 - Updated Sep 2026: PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
...
- [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12532 - Updated Sep 2026: Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- [Wish](https://github.com/charmbracelet/wish) ⭐ 5513 - Updated Sep 2026: Make SSH apps, just like that!
- [Kono](https://github.com/starwalkn/kono) ⭐ 23 - Updated Sep 2026: lightweight extendable API Gateway in Go - parallel fan-out, flexible aggregation, and zero configuration magic.
...
- [maroto](https://github.com/johnfercher/maroto) ⭐ 2756 - Updated Sep 2026: A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- [templ](https://github.com/a-h/templ) ⭐ 10542 - Updated Jul 2026: A HTML templating language that has great developer tooling.
...
- [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) ⭐ 1233 - Updated Mar 2026: Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- [go-vcr](https://github.com/dnaeon/go-vcr) ⭐ 1394 - Updated Sep 2026: Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
- [keploy](https://github.com/keploy/keploy) ⭐ 18463 - Updated Sep 2026: Generate Testcase and Data Mocks from API calls automatically.
...
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) ⭐ 4982 - Updated Sep 2026: A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- [Testo](https://github.com/ozontech/testo) ⭐ 156 - Updated Aug 2026: Plugin-based testing framework with suites, parallel tests, hooks and parametrization. Inspired by Pytest.
...
- [rod](https://github.com/go-rod/rod) ⭐ 7103 - Updated Aug 2026: A Devtools driver to make web automation and scraping easy.
...
- [failpoint](https://github.com/pingcap/failpoint) ⭐ 895 - Updated Aug 2026: An implementation of failpoints for Golang.
...
- [go-humanize](https://github.com/dustin/go-humanize) ⭐ 4828 - Updated Sep 2026: Formatters for time, numbers, and memory size to human readable format.
...
- [blackfriday](https://github.com/russross/blackfriday) ⭐ 5600 - Updated Oct 2020: Markdown processor in Go.
...
- [go-toml](https://github.com/pelletier/go-toml) ⭐ 1984 - Updated Jul 2026: Go library for the TOML format with query support and handy cli tools.
- [goldmark](https://github.com/yuin/goldmark) ⭐ 5020 - Updated Sep 2026: A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ⭐ 3816 - Updated Jun 2026: Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- [sh](https://github.com/mvdan/sh) ⭐ 9063 - Updated Sep 2026: Shell parser and formatter.
...
- [coregex](https://github.com/coregx/coregex) ⭐ 258 - Updated Sep 2026: Production regex engine with Rust regex-crate architecture: multi-engine DFA/NFA, SIMD prefilters, drop-in stdlib replacement.
...
- [colly](https://github.com/asciimoo/colly) ⭐ 25520 - Updated Sep 2026: Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) ⭐ 14990 - Updated Sep 2026: GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [discordgo](https://github.com/bwmarrin/discordgo) ⭐ 5994 - Updated Feb 2026: Go bindings for the Discord Chat API.
...
- [go-openai](https://github.com/sashabaranov/go-openai) ⭐ 10767 - Updated Sep 2026: OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [slack](https://github.com/slack-go/slack) ⭐ 4961 - Updated Aug 2026: Slack API in Go.
...
- [dive](https://github.com/wagoodman/dive) ⭐ 54570 - Updated May 2025: A tool for exploring each layer in a Docker image.
...
- [fzf](https://github.com/junegunn/fzf) ⭐ 83071 - Updated Sep 2026: Command-line fuzzy finder written in Go.
...
- [goreleaser](https://github.com/goreleaser/goreleaser) ⭐ 16054 - Updated Sep 2026: Deliver Go binaries as fast and easily as possible.
...
- [lo](https://github.com/samber/lo) ⭐ 21432 - Updated Sep 2026: A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [usql](https://github.com/knq/usql) ⭐ 10117 - Updated Sep 2026: usql is a universal command-line interface for SQL databases.
...
- [validator](https://github.com/go-playground/validator) ⭐ 20171 - Updated Sep 2026: Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [go-git](https://github.com/go-git/go-git) ⭐ 7723 - Updated Sep 2026: highly extensible Git implementation in pure Go.
...
- [Fastschema](https://github.com/fastschema/fastschema) ⭐ 573 - Updated Jun 2026: A flexible Go web framework and Headless CMS.
- [Fiber](https://github.com/gofiber/fiber) ⭐ 40160 - Updated Sep 2026: An Express.js inspired web framework build on Fasthttp.
...
- [Hertz](https://github.com/cloudwego/hertz) ⭐ 7365 - Updated Aug 2026: A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- [Huma](https://github.com/danielgtaylor/huma/) ⭐ 4402 - Updated Aug 2026: Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- [iWF](https://github.com/indeedeng/iwf) ⭐ 660 - Updated Aug 2026: iWF is an all-in-one platform for developing long-running business processes. It offers a convenient abstraction for utilizing databases, ElasticSearch, message queues, durable timers, and more, with a clean, simple, and user-friendly interface.
...
- [templui](https://github.com/axzilla/templui) ⭐ 1743 - Updated Sep 2026: Modern UI Components for Go & Templ.
...
- [chi](https://github.com/go-chi/chi) ⭐ 22839 - Updated Sep 2026: Small, fast and expressive HTTP router built on net/context.
...
- [tinygo](https://github.com/tinygo-org/tinygo) ⭐ 17734 - Updated Sep 2026: Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- [webhook](https://github.com/adnanh/webhook) ⭐ 12134 - Updated Sep 2026: Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [WebhookX](https://github.com/webhookx-io/webhookx) ⭐ 299 - Updated Aug 2026: A webhooks gateway for message receiving, processing, and reliable delivering.
...
- [Dagu](https://github.com/dagu-go/dagu) ⭐ 4023 - Updated Sep 2026: No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [workflow](https://github.com/luno/workflow) ⭐ 255 - Updated Sep 2026: A tech stack agnostic Event Driven Workflow framework.
...
- [Cosign](https://github.com/sigstore/cosign) ⭐ 6310 - Updated Sep 2026: Container Signing, Verification and Storage in an OCI registry.
...
- [OpenZiti](https://github.com/openziti/ziti) ⭐ 4392 - Updated Sep 2026: A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as golang allowing you to embed zero trust principles directly into your applications. The OpenZiti Test Kitchen has numerous examples to draw inspiration from including a zero trust ssh client - zssh
...
- [Spire](https://github.com/spiffe/spire) ⭐ 2542 - Updated Sep 2026: SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 19385 - Updated Sep 2026: A fast Go linters runner. It runs linters in parallel, uses caching, supports yaml config, has integrations with all major IDE and has dozens of linters included.
...
- [GoPlantUML](https://github.com/jfeliu007/goplantuml) ⭐ 2082 - Updated Sep 2025: Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- [vscode-go](https://github.com/golang/vscode-go) ⭐ 4262 - Updated Sep 2026: Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [go-callvis](https://github.com/TrueFurby/go-callvis) ⭐ 6518 - Updated Nov 2025: Visualize call graph of your Go program using dot format.
...
- [lensm](https://github.com/loov/lensm) ⭐ 3688 - Updated Aug 2026: Go assembly and source viewer.
...
- [bombardier](https://github.com/codesenberg/bombardier) ⭐ 6837 - Updated Mar 2025: Fast cross-platform HTTP benchmarking tool.
...
- [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17135 - Updated Oct 2024: A resiliency tool that helps applications tolerate random instance failures.
- [colima](https://github.com/abiosoft/colima) ⭐ 30853 - Updated Sep 2026: Container runtimes on macOS (and Linux) with minimal setup.
...
- [Fleet device management](https://github.com/fleetdm/fleet) ⭐ 6873 - Updated Sep 2026: Lightweight, programmable telemetry for servers and workstations.
...
- [ghorg](https://github.com/gabrie30/ghorg) ⭐ 2145 - Updated Sep 2026: Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- [Gitea](https://github.com/go-gitea/gitea) ⭐ 58048 - Updated Sep 2026: Fork of Gogs, entirely community driven.
...
- [GVM](https://github.com/moovweb/gvm) ⭐ 11690 - Updated Aug 2023: GVM provides an interface to manage Go versions.
- [Hey](https://github.com/rakyll/hey) ⭐ 20265 - Updated Jan 2026: Hey is a tiny program that sends some load to a web application.
...
- [k0s](https://github.com/k0sproject/k0s) ⭐ 6484 - Updated Sep 2026: Zero Friction Kubernetes distribution.
- [k3d](https://github.com/k3d-io/k3d) ⭐ 6556 - Updated Jun 2026: Little helper to run CNCF's k3s in Docker.
- [k3s](https://github.com/k3s-io/k3s) ⭐ 33979 - Updated Sep 2026: Lightweight Kubernetes.
- [k6](https://github.com/grafana/k6) ⭐ 31517 - Updated Sep 2026: A modern load testing tool, using Go and JavaScript.
- [k9s](https://github.com/derailed/k9s) ⭐ 34617 - Updated Sep 2026: Kubernetes CLI to manage your clusters in style.
...
- [kind](https://github.com/kubernetes-sigs/kind) ⭐ 15495 - Updated Sep 2026: Kubernetes IN Docker - local clusters for testing Kubernetes.
...
- [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3129 - Updated Sep 2026: KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
...
- [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 127794 - Updated Sep 2026: Container Cluster Manager from Google.
...
- [KubeVela](https://github.com/kubevela/kubevela) ⭐ 7897 - Updated Sep 2026: Cloud native application delivery.
- [KubeVPN](https://github.com/kubenetworks/kubevpn) ⭐ 1367 - Updated Sep 2026: KubeVPN offers a Cloud-Native Dev Environment that seamlessly connects to your Kubernetes cluster network.
...
- [minikube](https://github.com/kubernetes/minikube) ⭐ 32134 - Updated Sep 2026: Run Kubernetes locally.
- [Moby](https://github.com/moby/moby) ⭐ 72109 - Updated Sep 2026: Collaborative project for the container ecosystem to assemble container-based systems.
...
- [Packer](https://github.com/mitchellh/packer) ⭐ 15792 - Updated Sep 2026: Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
- [podinfo](https://github.com/stefanprodan/podinfo) ⭐ 5994 - Updated Aug 2026: Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- [podman-tui](https://github.com/containers/podman-tui) ⭐ 1229 - Updated Sep 2026: Terminal UI for Podman management.
- [Pomerium](https://github.com/pomerium/pomerium) ⭐ 5008 - Updated Sep 2026: Pomerium is an identity-aware access proxy.
...
- [traefik](https://github.com/containous/traefik) ⭐ 64880 - Updated Sep 2026: Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25192 - Updated Feb 2026: HTTP load testing tool and library. It's over 9000!
...
- [Backrest](https://github.com/garethgeorge/backrest) ⭐ 7362 - Updated Jul 2026: Web-based UI and orchestrator for restic backup.
- [Better Go Playground](https://goplay.tools): Go playground with syntax highlight, code completion and other features.
- [blocky](https://github.com/0xERR0R/blocky) ⭐ 6952 - Updated Sep 2026: Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc](https://github.com/schollz/croc) ⭐ 40366 - Updated Sep 2026: Easily and securely send files or folders from one computer to another.
...
- [GoNB](https://github.com/janpfeifer/gonb) ⭐ 1047 - Updated Jul 2026: Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
- [Gor](https://github.com/buger/gor) ⭐ 19322 - Updated Apr 2025: Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 14436 - Updated Sep 2026: Distributed POSIX file system built on top of Redis and AWS S3.
...
- [onWatch](https://github.com/onllm-dev/onWatch) ⭐ 742 - Updated Sep 2026: Monitor AI API quotas across providers locally with historical tracking, alerts, and a web dashboard to avoid surprise throttling and budget overruns.
...
- [Plik](https://github.com/root-gg/plik) ⭐ 1824 - Updated Jul 2026: Plik is a temporary file upload system (Wetransfer like) in Go.
...
- [restic](https://github.com/restic/restic) ⭐ 36101 - Updated Aug 2026: De-duplicating backup program.
- [sake](https://github.com/alajmo/sake) ⭐ 752 - Updated May 2026: sake is a command runner for local and remote hosts.
- [scc](https://github.com/boyter/scc) ⭐ 8760 - Updated Sep 2026: Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
...
- [tldx](https://github.com/brandonyoungdev/tldx) ⭐ 1922 - Updated Aug 2026: Bulk domain availability checker using RDAP, DNS, and WHOIS fallback with keyword permutation generation.
- [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12348 - Updated Aug 2026: Proxy to simulate network and system conditions for automated tests.
...
- [GoBooks](https://github.com/dariubs/GoBooks) ⭐ 19676 - Updated Jul 2026: A curated list of Go books.
...
- [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) ⭐ 3990 - Updated Dec 2024: Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 48762 - Updated Aug 2026: Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33679 - Updated Mar 2022: List of other amazingly awesome lists.
...
- [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) ⭐ 43898 - Updated Sep 2022: Golang ebook intro how to build a web app with golang.
...
- [go-patterns](https://github.com/tmrts/go-patterns) ⭐ 28239 - Updated Jul 2017: Curated list of Go design patterns, recipes and idioms.
- [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) ⭐ 4762 - Updated Nov 2022 - ⚠️ Archived: Examples of Golang compared to Node.js for learning.
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) ⭐ 20144 - Updated Jun 2025: Learn Go with thousands of examples, exercises, and quizzes.
...
- [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) ⭐ 2472 - Updated Sep 2026: A GitHub repository offering coding challenges for Go technical interview preparation.
